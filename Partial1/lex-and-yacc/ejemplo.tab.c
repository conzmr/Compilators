...
using namespace std;
#include "comun.h"
// variables y funciones del A. L´exico
...
{
      14,     0,    -1,     3,    15,    11,    -1,    15,    12,    16,
      -1,    16,    -1,    16,     5,    17,    -1,    17,    -1,     7,
      -1,     8,    -1,     9,    16,    10,    -1,     4,    -1
};
  ...
  switch (yyn)
    {
        case 2:
#line 24 "ejemplo.y"
    { /* comprobar que despu´es del programa no hay ning´un token m´as */
int tk = yylex();
if (tk != 0) yyerror("");
;}
    break;
  ...
  case 3:
#line 29 "ejemplo.y"
    { cout << (yyvsp[(3) - (3)]).cod << endl; ;}
    break;

  case 4:
#line 30 "ejemplo.y"
    { cout << (yyvsp[(1) - (1)]).cod << endl; ;}
    break;
...
s1 = "itor(" + (yyvsp[(1) - (3)]).cod + ")";
else
s1 = (yyvsp[(1) - (3)]).cod;
if ((yyvsp[(3) - (3)]).tipo == ENTERO)
s2 = "itor(" + (yyvsp[(3) - (3)]).cod + ")";
else
s2 = (yyvsp[(3) - (3)]).cod;
operador +="r";
(yyval).tipo = REAL;
